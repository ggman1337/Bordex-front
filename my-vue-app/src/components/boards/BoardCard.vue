<template>
  <div :id="`board-${board.id}`" :class="['relative bg-card text-card-foreground rounded-xl shadow p-5 flex flex-col min-w-[10rem] max-w-[20rem]', isCurrent ? 'border-2 border-blue-500' : '']" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" @dblclick="openBoard">
    <div class="flex-1">
