<template>
  <div class="flex justify-center items-center min-h-[80vh]">
    <div class="bg-white dark:bg-black rounded-2xl shadow-xl p-8 w-full max-w-md flex flex-col gap-6">
      ...
      <form @submit.prevent="onSubmit" class="flex flex-col gap-4">
        ...
        <button type="button" class="w-full flex items-center justify-center gap-2 border border-blue-400 text-blue-600 rounded-lg py-2 font-medium hover:bg-blue-50 transition">
